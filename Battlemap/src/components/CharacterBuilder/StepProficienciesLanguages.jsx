  ...
  return (
    <Box>
      ...
      <Box sx={{
        ...
        <Typography variant="body2" sx={{ opacity:0.8, minHeight:24, gridColumn: { xs:'1', md:'2' }, gridRow: 1 }}>Existing Languages</Typography>
        ...
        <Box sx={{ display:'flex', flexWrap:'wrap', gap:1, mt:1, gridColumn: { xs:'1', md:'2' }, gridRow: 2 }}>
        ...
        <Divider sx={{ my:2, borderColor:'rgba(255,255,255,0.15)', gridColumn: { xs:'1', md:'2' }, gridRow: 3 }} />
        ...
        <Typography variant="body2" sx={{ opacity:0.8, mb:1, minHeight:24, gridColumn: { xs:'1', md:'2' }, gridRow: 4 }}>Add More</Typography>
        ...
        <Box sx={{ maxHeight:260, overflow:'auto', pr:1, gridColumn: { xs:'1', md:'2' }, gridRow: 5 }}>
          {allLangs.map(l => (
